...
var _Todos_instances, _Todos_backendUrl, _Todos_readJson, _Todos_addToArray, _Todos_removeFromArray;
...
class Todos {
    constructor(url) {
        ...
        this.removeTask = (id) => {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                fetch(`${__classPrivateFieldGet(this, _Todos_backendUrl, "f")}/delete/${id}`, { method: "delete" })
                    .then((response) => response.json())
                    .then((response) => {
